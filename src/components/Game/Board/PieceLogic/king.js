const wking= (i,j,piece,wall,green)=>{
    let ii=i+1;
    if(ii<10){
        if((piece[ii][j]>0/*&&piece[ii][j]<5*/) || piece[ii-1][j]<0 || wall[ii][j]===1 || wall[ii-1][j]===3){
     ...
     ii=i-1;
    if(ii>-1){
        if((piece[ii][j]>0/*&&piece[ii][j]<5*/) || piece[ii+1][j]<0 || wall[ii][j]===3 || wall[ii+1][j]===1){
     ...
     ii=j+1;
    if(ii<15){
        if((piece[i][ii]>0/*&&piece[i][ii]<5*/) || piece[i][ii-1]<0 || wall[i][ii]===2 || wall[i][ii-1]===4){
     ...
     ii=j-1;
    if(ii>-1){
        if((piece[i][ii]>0/*&&piece[i][ii]<5*/) || piece[i][ii+1]<0 || wall[i][ii]===4 || wall[i][ii+1]===2){
...
const bking= (i,j,piece,wall,green)=>{
    let ii=i+1;
    if(ii<10){
        if((piece[ii-1][j]>0/*&&piece[ii-1][j]<5*/) || piece[ii][j]<0 || wall[ii][j]===1 || wall[ii-1][j]===3){
     ...
     ii=i-1;
    if(ii>-1){
        if((piece[ii+1][j]>0/*&&piece[ii+1][j]<5*/) || piece[ii][j]<0 || wall[ii][j]===3 || wall[ii+1][j]===1){
     ...
     ii=j+1;
    if(ii<15){
        if((piece[i][ii-1]>0/*&&piece[i][ii-1]<5*/) || piece[i][ii]<0 || wall[i][ii]===2 || wall[i][ii-1]===4){
     ...
     ii=j-1;
    if(ii>-1){
        if((piece[i][ii+1]>0/*&&piece[i][ii+1]<5*/) || piece[i][ii]<0 || wall[i][ii]===4 || wall[i][ii+1]===2){
